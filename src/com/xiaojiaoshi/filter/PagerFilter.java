package com.xiaojiaoshi.filter;
...
public class PagerFilter implements Filter
{
	...
	{
		ThreadLocalUtil.setPagerSize(pageSize);
		try
		{
			try
			{
				...
				if(sOffset==null||"".equals(sOffset)){
					...
					ThreadLocalUtil.setPageroffset(_pageroffset);
					chain.doFilter(request, response);
				}
			} catch (NumberFormatException e){}
		} finally {
			ThreadLocalUtil.removePageroffset();
			ThreadLocalUtil.removePagerSize();
		}
