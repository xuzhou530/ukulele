...
<!-- 侧边栏结束 -->
      ...
      <div class="content-wrapper ">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<%=path %>/HouTai/listVedio"><i class="fa fa-dashboard"></i> 首页</a></li>
            ...
            <div class="box">
              ...
              <div class="box-body table-responsive no-padding">
                <table id="example1" class="table table-bordered table-striped table-hover">
                  ...
                  <tbody>
                    <s:iterator value="vedios" var="vedio" status="iIndex">
                    <tr>
                      <td><s:property value="#iIndex.index"/></td>
                      
                      <td title="<s:property value="#vedio.obj.vediokey" />"><div><s:property value="#vedio.obj.vediokey" /></div></td>
                      <td title="<s:property value="#vedio.obj.vedioTitle" />"><div><s:property value="#vedio.obj.vedioTitle" /></div></td>
                      <td title="<s:property value="#vedio.obj.vedioCount" />"><div><s:property value="#vedio.obj.vedioCount" escapeHtml="false" /></div></td>
                      <td title="<s:property value="#vedio.obj.musicName" />"><div><s:property value="#vedio.obj.musicName" /></div></td>
                      <td title="曲谱图片"><div><div class="musicPic">
                      	<s:iterator value="#vedio.picsrc" var="src">
                      		<img alt="曲谱图片" src='<s:property value="#src" />'>	
                      	</s:iterator>
                      	</div></div></td>
                      <td > <p style="width: 156px;"><a href="<%=path %>/HouTai/update_vedio?vedio.id=<s:property value="#vedio.obj.id"/>"><button class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i>修改</button></a>
                        <a href="<%=path %>/HouTai/deleteVedio?vedio.id=<s:property value="#vedio.obj.id"/>"><button class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>删除</button></a></p></td>
                    </tr>
                    </s:iterator>
                  </tbody>
