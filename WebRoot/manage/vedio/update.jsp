        ...
        <section class="content">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
				<div class="row">
                  <div class="col-sm-12">
                    <form class="form-horizontal col-sm-10 col-sm-offset-1" action="<%=path %>/HouTai/updateVedio" id="addMusic"  method="post"  enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6"  >
                          <input type="text"  class="form-control" name="vedio.musicName" value="<s:property value="#vedio.musicName" />" placeholder="标题部分" required  />
                        </div>
                      </div>
                      ...
                      <div class="box box-default">
                        ...
                        <div class="box-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6"  >
                              <input type="text"  name="vedio.vediokey" value="<s:property value="#vedio.vediokey" />" class="form-control" placeholder="key" />
                            </div>
                          </div>
					  <!-- 视频封面 -->
                      <div class="form-group">
                        <label class="col-sm-2 control-label"><i class="ion-ios-medical text-danger"></i>视频封面：</label>
                        <div class="col-sm-6" id="musicSrcWrapper">
                          <div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-6"  >
                              <input type="text" name="vedio.vedioTitle" value="<s:property value="#vedio.vedioTitle" />"  class="form-control" placeholder="教程标题" />
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10" style="height: 180px;" >
                              <textarea class="form-control" name="vedio.vedioCount"  rows="4"  cols="4" ><s:property value="#vedio.vedioCount" /></textarea>
                            </div>
                          </div>
                        </div>
